				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							NotificationManager notManager = (NotificationManager) mApplicationContext.getSystemService(Context.NOTIFICATION_SERVICE);
							notManager.notify(MY_NOTIFICATION_ID, notificationBuilder.build());
